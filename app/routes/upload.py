...
from app.controller.copy_todirectory import copy_docker_files
...
def upload_zip():
    ...
    # === Nếu cần thì tạo Dockerfile & docker-compose.yml ===
    dockerfile_path = os.path.join(project_extract_path, "Dockerfile")
    compose_path = os.path.join(project_extract_path, "docker-compose.yml")
    ...
    # === Đảm bảo sao chép file mẫu nếu cần ===
    copy_docker_files(project_extract_path)
